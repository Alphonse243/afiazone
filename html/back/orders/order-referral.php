                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-column flex-sm-row justify-content-between text-center gap-3">
                        <div class="d-flex flex-column align-items-center">
                          <span
                            ><i
                              class="ti ti-rocket text-primary ti-xl p-3 border border-1 border-primary rounded-circle border-dashed mb-0"></i
                          ></span>
                        ...
                        <div class="d-flex flex-column align-items-center">
                          <span
                            ><i
                              class="ti ti-id text-primary ti-xl p-3 border border-1 border-primary rounded-circle border-dashed mb-0"></i
                          ></span>
                        ...
                        <div class="d-flex flex-column align-items-center">
                          <span
                            ><i
                              class="ti ti-send text-primary ti-xl p-3 border border-1 border-primary rounded-circle border-dashed mb-0"></i
                          ></span>
                          ...
                          <div class="d-flex flex-wrap gap-3 align-items-end">
                            ...
                            <div>
                              <button type="button" class="btn btn-facebook btn-icon me-2">
                                <i class="ti ti-brand-facebook text-white ti-sm"></i>
                              </button>
                              <button type="button" class="btn btn-twitter btn-icon">
                                <i class="ti ti-brand-twitter text-white ti-sm"></i>
                              </button>
                            </div>
                          </div>
                        </div>
