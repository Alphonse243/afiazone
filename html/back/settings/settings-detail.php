...
<html
  ...
  <head>
    ...
    <title>Settings Store Details - eCommerce | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">eCommerce /</span> Settings</h4>
                ...
                <div class="col-12 col-lg-4">
                  <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                    <ul class="nav nav-align-left nav-pills flex-column">
                      ...
                      <li class="nav-item mb-1">
                        <a class="nav-link py-2" href="app-ecommerce-settings-payments.html">
                          <i class="ti ti-credit-card me-2"></i>
                          <span class="align-middle">Payments</span>
                        </a>
                      </li>
                      <li class="nav-item mb-1">
                        <a class="nav-link py-2" href="app-ecommerce-settings-checkout.html">
                          <i class="ti ti-shopping-cart me-2"></i>
                          <span class="align-middle">Checkout</span>
                        </a>
                      </li>
                      <li class="nav-item mb-1">
                        <a class="nav-link py-2" href="app-ecommerce-settings-shipping.html">
                          <i class="ti ti-discount-2 me-2"></i>
                          <span class="align-middle">Shipping & delivery</span>
                        </a>
                      </li>
                      <li class="nav-item mb-1">
                        <a class="nav-link py-2" href="app-ecommerce-settings-locations.html">
                          <i class="ti ti-map-pin me-2"></i>
                          <span class="align-middle">Locations</span>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link py-2" href="app-ecommerce-settings-notifications.html">
                    ...
                    <div class="tab-pane fade show active" id="store_details" role="tabpanel">
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="row mb-3 g-3">
                            ...
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-0" for="ecommerce-settings-details-email"
                            ...
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-0" for="ecommerce-settings-sender-email">Sender email</label>
                              <input
                                type="email"
                                class="form-control"
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="row g-3">
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-0" for="business-name">Legal business name</label>
                            ...
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-0" for="bill_address">Address</label>
                              <input type="text" id="bill_address" class="form-control" placeholder="Address" />
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-0" for="apa_suite">Apartment, suite, etc.</label>
                              <input
                                type="text"
                                id="apa_suite"
                                class="form-control"
                            ...
                            <div class="col-12 col-md-4">
                              <label class="form-label mb-0" for="bill_city">City</label>
                              <input type="text" id="bill_city" class="form-control" placeholder="City" />
                            </div>
                            <div class="col-12 col-md-4">
                              <label class="form-label mb-0" for="bill_state">State</label>
                              <input type="text" id="bill_state" class="form-control" placeholder="State" />
                            </div>
                            <div class="col-12 col-md-4">
                              <label class="form-label mb-0" for="bill_pincode">PIN Code</label>
                              <input
                                type="number"
                                id="bill_pincode"
                                class="form-control"
                      ...
                      <div class="card mb-4">
                        <div class="card-header">
                          <div class="card-title mb-0">
                            <h5 class="m-0 mb-1">Time zone and units of measurement</h5>
                        ...
                        <div class="card-body">
                          <div class="row g-3">
                            <div class="col-12">
                              <label for="timeZones" class="form-label mb-0">Time zone</label>
                              <select
                                id="timeZones"
                            ...
                            <div class="col-12 col-md-6">
                              <label for="unitSystemDropdown" class="form-label mb-0">Unit system</label>
                            ...
                            <div class="col-12 col-md-6">
                              <label for="weightUnits" class="form-label mb-0">Default weight unit</label>
                      ...
                      <div class="card mb-4">
                        <div class="card-header">
                          <div class="card-title mb-0">
                            <h5 class="m-0 mb-1">Store currency</h5>
                            <p class="text-muted mb-0">The currency your products are sold in.</p>
                          </div>
                        </div>
                        <div class="card-body">
                          <div>
                      ...
                      <div class="card mb-4">
                        <div class="card-header">
                          <div class="card-title mb-0">
                            <h5 class="m-0 mb-1">Order id format</h5>
                            <p class="text-muted mb-0">
                              Shown on the Orders page, customer pages, and customer order notifications to identify
                              orders.
                            </p>
                          </div>
                        </div>
                        <div class="card-body">
                          <div class="row mb-3 g-3">
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-0" for="ecommerce-settings-details-prefix">Prefix</label>
                              <div class="input-group input-group-merge">
                                <span class="input-group-text text-muted">#</span>
                                <input
                                  type="number"
                                  class="form-control"
                                  id="ecommerce-settings-details-prefix"
                                  name="prefix"
                                  aria-label="Prefix"
                                  min="0" />
                              </div>
                              <p class="text-muted mb-0 pt-2">Your order ID will appear as #1001, #1002, #1003 ...</p>
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-0" for="ecommerce-settings-sender-suffix">Suffix</label>
                              <input
                                type="text"
                                class="form-control"
                                id="ecommerce-settings-sender-suffix"
                                name="suffix"
                                aria-label="Suffix" />
                            </div>
                          </div>
