...
<html
  ...
  <head>
    ...
    <title>Settings Checkout - eCommerce | Vuexy - Bootstrap Admin Template</title>
                  ...
                  <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                    <ul class="nav nav-align-left nav-pills flex-column">
                      <li class="nav-item mb-1">
                        <a class="nav-link py-2" href="app-ecommerce-settings-detail.html">
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="contactMail"> Email </label>
                          </div>
                        ...
                        <div class="card-body">
                          <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                              ...
                              <label class="form-check-label" for="last_name"> Only require last name </label>
                            </div>
                          ...
                          <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                              <input
                                ...
                                type="radio"
                                name="companyName"
                                id="dont_include_name"
                                checked />
                              <label class="form-check-label" for="dont_include_name"> Don't include name </label>
                            </div>
                            <div class="form-check mb-2">
                              <input class="form-check-input" type="radio" name="companyName" id="optional_name" />
                              <label class="form-check-label" for="optional_name"> Optional </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="companyName" id="required_name" />
                              <label class="form-check-label" for="required_name"> Required </label>
                            </div>
                          </div>
                          <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                              <input
                                ...
                                type="radio"
                                name="addressLine"
                                id="dont_include_address"
                                checked />
                              <label class="form-check-label" for="dont_include_address"> Don't include name </label>
                            </div>
                            <div class="form-check mb-2">
                              <input class="form-check-input" type="radio" name="addressLine" id="optional_address" />
                              <label class="form-check-label" for="optional_address"> Optional </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="addressLine" id="required_address" />
                              <label class="form-check-label" for="required_address"> Required </label>
                            </div>
                          </div>
                          <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                              <input
                                ...
                                type="radio"
                                name="shippingAddress"
                                id="optional_ship_address" />
                              <label class="form-check-label" for="optional_ship_address"> Optional </label>
                            </div>
                            <div class="form-check">
                              <input
                                class="form-check-input"
                                type="radio"
                                name="shippingAddress"
                                id="required_ship_address" />
                              <label class="form-check-label" for="required_ship_address"> Required </label>
                            </div>
                          </div>
                        </div>
                      </div>
