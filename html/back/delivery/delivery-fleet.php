...
<html
  ...
  <head>
    ...
    <title>Fleet - Logistics | Vuexy - Bootstrap Admin Template</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="alert alert-primary alert-dismissible" role="alert">
                ...
                <a
                  href="https://demos.pixinvent.com/vuexy-html-admin-template/documentation//faq.html#mapbox-not-loading"
                  class="alert-link"
                  target="_blank"
                  >documentation</a
                >.
              ...
              <div class="card overflow-hidden">
                ...
                <div class="row app-logistics-fleet-wrapper">
                  ...
                  <div class="flex-shrink-0 position-fixed m-4 d-md-none w-auto zindex-1">
                    <button
                      class="btn btn-label-white border border-2 zindex-2 p-2"
                  ...
                  <div class="app-logistics-fleet-sidebar col h-100" id="app-logistics-fleet-sidebar">
                    <div class="card-header border-0 pt-4 pb-2 d-flex justify-content-between">
                      ...
                      <i
                        class="ti ti-x ti-xs cursor-pointer close-sidebar d-md-none btn btn-label-secondary p-0"
                        data-bs-toggle="sidebar"
                        data-overlay
                        data-target="#app-logistics-fleet-sidebar"></i>
                    </div>
