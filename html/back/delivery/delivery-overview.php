...
<html
  ...
  <head>
    ...
    <title>Overview - Logistics | Vuexy - Bootstrap Admin Template</title>
    ...
    <link rel="stylesheet" href="/assets/vendor/css/pages/app-logistics-overview.css" />
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Logistics /</span> Overview</h4>
    ...
    <!-- Page JS -->
    <script src="/assets/js/app-logistics-overview.js"></script>
  </body>
</html>
