...
<html
  ...
  <head>
    ...
    <title>Dropdowns - UI elements | Vuexy - Bootstrap Admin Template</title>
                ...
                <div class="card-body">
                  ...
                  <div class="demo-inline-spacing">
                    ...
                    <div class="btn-group">
                      <button
                        type="button"
                        class="btn btn-label-success dropdown-toggle"
                        data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Success
                      </button>
                    ...
                    <div class="btn-group">
                      <button
                        type="button"
                        class="btn btn-label-danger dropdown-toggle"
                        data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Danger
                      </button>
                    ...
                    <div class="btn-group">
                      <button
                        type="button"
                        class="btn btn-label-info dropdown-toggle"
                        data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Info
                      </button>
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group" id="dropdown-icon-demo">
                          <button
                            ...
                            data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="ti ti-menu-2 ti-xs me-1"></i> With Icon
                          </button>
                          <ul class="dropdown-menu">
                            <li>
