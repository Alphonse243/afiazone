...
<html
  ...
  <head>
    ...
    <title>Buttons - UI elements | Vuexy - Bootstrap Admin Template</title>
                      ...
                      <div class="col-lg-4 p-4">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-facebook">
                            <i class="tf-icons ti ti-brand-facebook ti-xs me-1"></i> Facebook
                          </button>
                          <button type="button" class="btn btn-twitter">
                            <i class="tf-icons ti ti-brand-twitter ti-xs me-1"></i> Twitter
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                      ...
                      <div class="col-lg-4 p-4">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-label-linkedin">
                            <i class="tf-icons ti ti-brand-linkedin ti-xs me-1"></i> Linkedin
                          </button>
                          <button type="button" class="btn btn-label-github">
                            <i class="tf-icons ti ti-brand-github ti-xs me-1"></i> Github
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-label-pinterest">
                            <i class="tf-icons ti ti-brand-pinterest ti-xs me-1"></i> Pinterest
                          </button>
                          <button type="button" class="btn rounded-pill btn-label-slack">
                            <i class="tf-icons ti ti-brand-slack ti-xs me-1"></i> Slack
                          </button>
                        </div>
                      </div>
                      <div class="col-lg-4 p-4">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-outline-dribbble">
                            <i class="tf-icons ti ti-brand-dribbble ti-xs me-1"></i> Dribbble
                          </button>
                          <button type="button" class="btn btn-outline-reddit">
                            <i class="tf-icons ti ti-brand-reddit ti-xs me-1"></i> Reddit
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-outline-youtube">
                            <i class="tf-icons ti ti-brand-youtube ti-xs me-1"></i> Youtube
                          </button>
                          <button type="button" class="btn rounded-pill btn-outline-vimeo">
                            <i class="tf-icons ti ti-brand-vimeo ti-xs me-1"></i> Vimeo
                          </button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row row-bordered g-0">
                      ...
                      <div class="col-lg-4 p-4">
                        ...
                        <div class="demo-inline-spacing">
                          ...
                          <button type="button" class="btn btn-icon btn-label-github">
                            <i class="tf-icons ti ti-brand-github"></i>
                          </button>
                      ...
                      <div class="col-lg-4 p-4">
                        ...
                        <div class="demo-inline-spacing">
                          ...
                          <button type="button" class="btn btn-icon btn-outline-reddit">
                            <i class="tf-icons ti ti-brand-reddit"></i>
                          </button>
