...
<html
  ...
  <head>
    ...
    <title>Footer - UI elements | Vuexy - Bootstrap Admin Template</title>
              ...
              <section id="basic-footer">
                ...
                <footer class="footer bg-light">
                  <div
                    ...
                    <div>
                      <a
                        href="https://demos.pixinvent.com/vuexy-html-admin-template/landing/"
                        target="_blank"
                        class="footer-text fw-medium"
                        >Vuexy</a
                      >
                      ©
                    </div>
                      ...
                      <div class="dropdown dropup footer-link me-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="ti ti-currency-dollar"></i> USD</a
                          >
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="ti ti-currency-euro"></i> Euro</a
                          >
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="ti ti-currency-pound"></i> Pound</a
                          >
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="ti ti-currency-bitcoin"></i> Bitcoin</a
                          >
                        </div>
                      </div>
                      <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"
                        ><i class="ti ti-logout me-1"></i>Logout</a
                      >
                    </div>
                  </div>
                </footer>
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li>
                            <a href="javascript:void(0)" class="footer-link d-block pb-2"
                              >Career <span class="badge bg-label-primary text-capitalize">We're hiring</span></a
                            >
                          </li>
