...
<html
  ...
  <head>
    ...
    <title>Navbar - UI elements | Vuexy - Bootstrap Admin Template</title>
                                ...
                                <ul class="nav flex-column">
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="tf-icons ti ti-mail ti-sm me-1"></i> Email</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="tf-icons ti ti-messages ti-sm me-1"></i> Chat</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="tf-icons ti ti-checklist ti-sm me-1"></i> ToDos</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="tf-icons ti ti-calendar ti-sm me-1"></i> Calender</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a
                                      ...
                                      href="javascript:void(0)"
                                      tabindex="-1"
                                      ><i class="tf-icons ti ti-ban ti-sm me-1"></i> Disabled</a
                                    >
                                  </li>
                                </ul>
                              </div>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-7">
                      ...
                      <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"
                            ><i class="tf-icons navbar-icon ti ti-settings ti-xs me-1"></i> Settings</a
                          >
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"
