...
<html
  ...
  <head>
    ...
    <title>Cards Actions- UI elements | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">UI Elements /</span> Cards Actions</h4>
              ...
              <p>
                Use <code>.card-action</code> class with <code>.card</code> class to create action card. Use
                <code>.card-action-title</code> for action card title and <code>.card-action-element</code> to warp the
                actions icons.
              </p>
              <div class="row mb-5">
                <div class="col-md">
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        To create a card with refresh action, use <code>.card-reload</code> class with action item. Use
                        <code>.card-alert</code> class to show custom response message.
                      </p>
                      <p class="card-text d-flex align-items-center gap-1">
                        Click on <i class="tf-icons ti ti-rotate-clockwise-2 scaleX-n1-rtl"></i> icon to see refresh
                        card content in action.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        To create a card with expand(fullscreen) action, use <code>.card-expand</code> class with action
                        item. Use <kbd>ESC</kbd> key to exit from the fullscreen mode.
                      </p>
                      <p class="card-text d-flex align-items-center gap-1">
                        Click on <i class="tf-icons ti ti-arrows-maximize"></i> icon to see expand card in action.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        Remove card action hide the card, use <code>.card-close</code> class with action item.
                      </p>
                      <br />
                      <p class="card-text d-flex align-items-center gap-1">
                        Click on <i class="tf-icons ti ti-x"></i> icon to see remove card in action.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-header header-elements">
                      ...
                      <div class="card-header-elements ms-auto">
                        <button type="button" class="btn btn-xs btn-primary">
                          <span class="tf-icon ti ti-plus ti-xs me-1"></span>Button
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
