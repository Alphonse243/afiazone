...
<html
  ...
  <head>
    ...
    <title>Font Awesome - Icons | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Icons /</span> Font Awesome</h4>
              ...
              <div class="d-flex flex-wrap" id="icons-container">
                ...
                <div class="card icon-card cursor-pointer text-center mb-4 mx-2">
                  <div class="card-body">
                    <i class="far fa-address-book mb-2"></i>
                    <p class="icon-name text-capitalize text-truncate mb-0">address-book</p>
                  </div>
                </div>
                <div class="card icon-card cursor-pointer text-center mb-4 mx-2">
                  <div class="card-body">
                    <i class="far fa-address-card mb-2"></i>
                ...
                <div class="card icon-card cursor-pointer text-center mb-4 mx-2">
                  <div class="card-body">
                    <i class="fas fa-angle-double-down mb-2"></i>
