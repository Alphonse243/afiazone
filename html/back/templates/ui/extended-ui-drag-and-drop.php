...
<html
  ...
  <head>
    ...
    <title>Drag and Drop - Extended UI | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Extended UI /</span> Drag &amp; Drop</h4>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="d-flex flex-wrap mb-3 gap-2" id="image-list-1">
                        <img
                          class="rounded-circle drag-item cursor-move"
