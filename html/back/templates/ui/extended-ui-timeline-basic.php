...
<html
  ...
  <head>
    ...
    <title>Basic Timeline - Extended UI | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Extended UI /</span> Basic Timeline</h4>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="d-flex flex-sm-row flex-column">
                              <img
                                src="/assets/img/elements/16.jpg"
                                class="rounded me-3"
                                alt="Shoe img"
                                height="62"
                                width="62" />
                  ...
                  <div class="card">
                    ...
                    <div class="card-body pb-0">
                      <ul class="timeline pt-3">
                        ...
                        <li class="timeline-item pb-0 timeline-item-dark border-transparent">
