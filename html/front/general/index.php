          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="category-area-main-wrapper-one">
                <div
                  class="swiper mySwiper-category-1 swiper-data"
                  data-swiper='{
                                "spaceBetween":1,
                                "slidesPerView":1,
                                "loop": true,
                    ...
                    <div class="swiper-slide">
                      <div class="banner-bg-image bg_image bg_one-banner ptb--120 ptb_md--80 ptb_sm--60">
                        <div class="banner-one-inner-content">
                          ...
                          <a href="shop-grid-sidebar.php" class="rts-btn btn-primary radious-sm with-icon">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="title-area-between">
              <h2 class="title-left">Featured Grocery</h2>
                    ...
                    <div class="single-shopping-card-one">
                      ...
                      <div class="body-content">
                        <a href="shop-details.php">
                          <h4 class="title">Nestle Cerelac Mixed Fruits & Wheat with Milk</h4>
                        </a>
    ...
    <div class="rts-grocery-feature-area rts-section-gapBottom">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="title-area-between">
              <h2 class="title-left">Products With Discounts</h2>
              <div class="countdown">
            ...
            <div class="product-with-discount">
              <div class="row g-5">
                <div class="col-xl-4 col-lg-12">
                  <a href="shop-details.php" class="single-discount-with-bg">
                    <div class="inner-content">
                      ...
                      <div class="price-area">
                        <span>Only</span>
                        <h4 class="title">$15.00</h4>
                      </div>
                    </div>
                  </a>
                  <a href="shop-details.php" class="single-discount-with-bg bg-2">
                    <div class="inner-content">
                      <h4 class="title">
                        Alpro Organic Flavored <br />
                        Fresh Juice
    ...
    <div class="weekly-best-selling-area rts-section-gap bg_light-1">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="title-area-between">
              <h2 class="title-left">Weekly Best Selling Groceries</h2>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="single-feature-card bg_image one">
              <div class="content-area">
                <a href="shop-grid-sidebar.php" class="rts-btn btn-primary">Weekend Discount</a>
                <h3 class="title">
                  Drink Fresh Corn Juice <br />
                  <span>Good Taste</span>
                </h3>
                <a href="shop-grid-sidebar.php" class="shop-now-goshop-btn">
    ...
    <div class="top-tranding-product rts-section-gap">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="title-area-between">
              <h2 class="title-left mb--10">Top Trending Products</h2>
            </div>
          </div>
        </div>
        <div class="row">
    ...
    <div class="blog-area-start rts-section-gapBottom">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="title-area-between">
              <h2 class="title-left mb--0">Latest Blog Post Insights</h2>
            </div>
          </div>
        </div>
        <div class="row">
                  ...
                  <div class="single-blog-area-start">
                    ...
                    <div class="blog-body">
                      ...
                      <a href="blog-details.php">
                        <h4 class="title">Shion Fixation: Fueling Your Passion for All Things Stylish</h4>
                      </a>
                      <a href="blog-details.php" class="shop-now-goshop-btn">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                  ...
                  <div class="single-blog-area-start">
                    ...
                    <div class="blog-body">
                      ...
                      <a href="blog-details.php">
                        <h4 class="title">Ashion Fixation: Fueling Your Passion for All Things Stylish</h4>
                      </a>
                      <a href="blog-details.php" class="shop-now-goshop-btn">
                        <span class="text">Read Details</span>
                        <div class="plus-icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                  ...
                  <div class="single-blog-area-start">
                    ...
                    <div class="blog-body">
                      ...
                      <a href="blog-details.php">
                        <h4 class="title">Fixation: Fueling Your Passion for All Things Stylish</h4>
                      </a>
                      <a href="blog-details.php" class="shop-now-goshop-btn">
                        <span class="text">Read Details</span>
                        <div class="plus-icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                  ...
                  <div class="single-blog-area-start">
                    ...
                    <div class="blog-body">
                      ...
                      <a href="blog-details.php">
                        <h4 class="title">Fashion Fixation: Fueling Your Passion for All Things Stylish</h4>
                      </a>
                      <a href="blog-details.php" class="shop-now-goshop-btn">
                        <span class="text">Read Details</span>
                        <div class="plus-icon">
