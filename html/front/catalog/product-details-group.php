                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                                    ...
                                    <div class="details-product-area">
                                        ...
                                        <div class="contents">
                                            ...
                                            <div class="product-bottom-action">
                                                <div class="number-counter-product-detrails-group">
                                                    <div class="cart-edits">
                                                        ...
                                                        <h4 class="title">Pecanera Brasil</h4>
                                                        <h4 class="title-price">$200.00</h4>
                                                    </div>
                                                    <div class="cart-edits">
                                                        <div class="quantity-edit action-item">
                                                            <button class="button"><i class="fal fa-minus minus"></i></button>
                                                        ...
                                                        <h4 class="title">Nestle Cerelac</h4>
                                                        <h4 class="title-price">$200.00</h4>
                                                    </div>
                                                    <div class="cart-edits">
                                                        <div class="quantity-edit action-item">
                                                        ...
                                                        <h4 class="title">Peysan Full Fat Fresh </h4>
                                                        <h4 class="title-price">$200.00</h4>
                                                    </div>
                                                </div>

                                            </div>
                                            <a href="#" class="rts-btn btn-primary radious-sm with-icon mt--20 mb--20">
                                                <div class="btn-text">
                                                    Add To Cart
                                                </div>
                                                <div class="arrow-icon">
                        ...
                        <div class="product-discription-tab-shop mt--50">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-panes" type="button" role="tab" aria-controls="profile-tab-panes" aria-selected="false">Customer Reviews (01)</button>
                                </li>
                            </ul>
