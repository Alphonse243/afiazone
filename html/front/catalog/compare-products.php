...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="navigator-breadcrumb-wrapper">
                        ...
                        <a class="current" href="index.php">Products Compare</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="compare-area-start rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <!-- compare start -->
                    <div class="modal-compare-area-start">
                        <div class="compare-title-area">
                            <h1 class="title">Products Compare</h1>
                            <span>There are <span>3</span> products to compare</span>
                        </div>
